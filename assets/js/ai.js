...
(function () {
  ...
  function scanCard() {
    ...
    /* No rescan button in here. The dock below carries the same one,
       word for word, a few hundred pixels down — and now that the list
       is five rows both are on the screen at once, which made the pair
       read as two different things rather than one said twice. This card
       states the finding; what to do about it lives in one place. */
